...
let BASE_URL = 'http://44.196.242.95:5000/api/';
let IMAGE_DETECTION_BASE_URL = 'http://44.196.242.95:5002/';

if (process.env.REACT_APP_ENV === 'production') {
  BASE_URL = 'http://44.196.242.95:5000/api/';
}

if (process.env.REACT_APP_ENV === 'development') {
  BASE_URL = 'http://44.196.242.95/api/';
}
