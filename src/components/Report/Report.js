...
const Report = (props) => {
  ...
  const { emailStaus, setEmailStatus } = useState('Email sent successfully');
      ...
      <div>
        <div id="report">
          ...
          <div className="company">
            <div className="company_info">
              ...
              <div>
                ...
                <p>
                  Universal Square Business Centre, Suite 1.16, Devonshire
          ...
          <div className="footer">
            <p
              style={{ fontWeight: '600', fontSize: '14px', color: 'darkblue' }}
            >
