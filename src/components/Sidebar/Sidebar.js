    ...
    <>
      <nav className="md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-white flex flex-wrap items-center justify-between relative md:w-64 z-10 py-4 ">
        <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
          ...
          {/* Brand */}
          <Link
            className="md:block text-left md:pb-2 text-blueGray-600 mr-0 inline-block whitespace-nowrap text-sm uppercase font-bold p-4 px-6"
            to="/"
          >
            <img src={require('assets/img/dashboard-logo.svg').default}></img>
          </Link>
          {/* User */}
          ...
          >
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              <li className="items-center">
                <Link
                  className={
                    'text-xs uppercase py-3 font-bold block px-7 ' +
                    (window.location.href.indexOf('/admin/test') !== -1
                      ? 'text-white bg-blue-900  transition duration-300 ease-in-out'
              ...
              <li className="items-center">
                ...
                >
                  {' '}
                  <i class="far fa-file-alt"></i>&nbsp;&nbsp;&nbsp; Custom
                  Report
                </Link>
              </li>
            </ul>
